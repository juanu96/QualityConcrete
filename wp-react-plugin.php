<?php
/*
Plugin Name: QualityConcrete
Description: Use the [QualityConcrete] shortcode to display the plugin
Version: 0.0.1
Author: Gustavo Gomez
Author URI: https://github.com/GustavoGomez092
*/

class QualityConcrete {
...
$QualityConcrete = new QualityConcrete();
$QualityConcrete->init();

function Quality_Concrete( $atts ) {
  ...
  return "<div id='QualityConcrete'></div>";
}

add_shortcode( 'QualityConcrete', 'Quality_Concrete' );