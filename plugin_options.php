...
class QualityConcrete_options {
  ...
  */
  ...
  public function register_plugin_settings() {
      register_setting( 'QualityConcrete-settings-group', 'QualityConcrete' );
  }
  ...
  */
  public function create_admin_menu_page() {
    $this->plugin_options_page = add_options_page('QualityConcrete', 'QualityConcrete', 'manage_options', __FILE__, array( $this, 'render_plugin_options_page' ) );
  }

  public function render_plugin_options_page() {
    echo '<div id="QualityConcrete"></div>';
  }
...
$QualityConcrete_options = new QualityConcrete_options();
$QualityConcrete_options->init();